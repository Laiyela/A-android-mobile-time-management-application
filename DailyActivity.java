    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnday1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent day1 = new Intent(DailyActivity.this, activity_main_day1.class);
                startActivity(day1);
            }
        });
        ...
        btnday2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent day2 = new Intent(DailyActivity.this, activity_main_day2.class);
                startActivity(day2);
            }
        });
        btnday3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent day3 = new Intent(DailyActivity.this, activity_main_day3.class);
                startActivity(day3);
            }
        });
        btnday4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent day4 = new Intent(DailyActivity.this, activity_main_day4.class);
                startActivity(day4);
            }
        });
        btnday5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent day5 = new Intent(DailyActivity.this, activity_main_day5.class);
                startActivity(day5);
            }
        });
        btnday6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent day6 = new Intent(DailyActivity.this, activity_main_day6.class);
                startActivity(day6);
            }
        });
        btnday7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent day7 = new Intent(DailyActivity.this, activity_main_day7.class);
                startActivity(day7);
            }
        });
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(DailyActivity.this, HomeActivity.class);
                startActivity(back);
            }
        });
    }
